...
**Dependencies** (core): `jax`, `jaxlib`, `astropy`, `numpy`, `photutils`, `scipy`, `gaiahealpixcache`. GPU support requires the appropriate JAX CUDA/Metal/ROCM installation.
...
seg, det_cat, bkg_map, bkg_var_map = gcp.detect_and_segment(image)
