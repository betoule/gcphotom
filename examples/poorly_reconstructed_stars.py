...
poorly = np.abs(fitted['flux'] / input_cat['flux']-1) > 3 * fitted['std_errors']['flux']/input_cat['flux']
...
for index in ~poorly, poorly:
    plt.errorbar(input_cat['flux'][index], ((fitted['flux'] / input_cat['flux'])[index]-1)*100, (fitted['std_errors']['flux']/input_cat['flux'])[index]*100, marker='o', ls='None')
